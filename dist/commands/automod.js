...
export const automodCommand = {
    data: new SlashCommandBuilder().setName('automod').setDescription('Configure automatic moderation.')
        ...
        .addStringOption((option) => option.setName('rule').setDescription('Rule to change.').setRequired(true).addChoices({ name: 'Links', value: 'links' }, { name: 'Invites', value: 'invites' }, { name: 'Excessive caps', value: 'caps' }, { name: 'Mention spam', value: 'mentions' }))
